...
<body>
   ...
   <div id='Content'>
     ...
     <div id="ftAwal">
       <img src="./assets/pandacoklat.gif" id="ftoAwal"/>
     </div>
     ...
     <div><div id='pergeseran'>
        ...
        <p><b><img src="./assets/pusn3.gif"/><br>
            <span>Hello, <span id="namaKamu"></span> 🫢❤️</span>
        </b></p>
        
        <p><b><img src="./assets/bunga2.gif"/><br>
            <span>Read this message when<br>you're alone 🫣</span>
        </b></p>
        
        <p><b><img src="./assets/panah.gif"/><br>
            <span>Someone's having a birthday! 😜</span>
        </b></p>
        
        <p><b><img src="./assets/pandamuter.gif"/><br>
     ...
     <img id="gift" src="./assets/1000353758.png" alt="Gift">
     <p id="teksgift">This is for you! 🫶</p>
     
     <div class="kumpulanstiker">
         <img src="./assets/hearthappy (1).gif" id="fotostiker"/>
         <img src="./assets/terlope2.gif" id="fotostiker1"/>
     </div>
     <div><blockquote id='bq'>
       <p id="teksnim">Wish You All The Best! 🥳</p>
       <p id="kalimat"><b>Happy birthday</b>! 💖 Wishing you a long life and always stay sweet. The world can be tiring sometimes, but you must keep your spirit up! 🫶<br><br>If the world feels unfair, you can come to me. Maybe I can't fix everything, but I'll always try to make you feel<br>better 💫<br><br>Once again,<br><span class="ft">Happy Birthday! 🫰💐</span></p>
     </blockquote></div>
